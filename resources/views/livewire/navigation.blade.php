            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <a href="/" class="flex-shrink-0 flex items-center">
                    <img class="block lg:hidden h-8 w-auto"
                        src="https://images.tcdn.com.br/img/img_prod/743137/1621338357_image-removebg-preview.png" alt="Workflow">
                    <img class="hidden lg:block h-8 w-auto"
                        src="https://images.tcdn.com.br/img/img_prod/743137/1621338357_image-removebg-preview.png"
                        alt="Workflow">
                </a>
                    ...
                    <div class="ml-3 relative" x-data="{ open:false }">
                        ...
                        <div x-show="open" x-on:click.away="open = false"
                            ...
                            <a href="{{ route('profile.show') }}" class="block px-4 py-2 text-sm text-gray-700"
                                role="menuitem" tabindex="-1" id="user-menu-item-0">Seu Perfil</a>

                            @can('admin.home')

                                <a href="{{ route('admin.home') }}" class="block px-4 py-2 text-sm text-gray-700"
                                    role="menuitem" tabindex="-1" id="user-menu-item-0">Painel</a>
                            @endcan
            ...
            @else
                ...
                <div>
                    ...
                    <a href="{{ route('register') }}"
                        class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Registrar</a>
                </div>
